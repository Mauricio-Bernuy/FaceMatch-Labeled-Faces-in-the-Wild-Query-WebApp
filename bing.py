...
class Bing:
    ...
    def download_image(self, link):
        ...
        # Get the image link
        try:
            linkobj = urllib.parse.urlsplit(link)
            path =  urllib.parse.quote(linkobj.path)
            #print("path:",path)
            link = linkobj.scheme + "://" + linkobj.netloc + path
            #print("parsed:", link)
            # print(path)
            ...
            # print("{}/{}/{}/".format(os.getcwd(), self.output_dir, self.query))
